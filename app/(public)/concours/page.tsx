...
const niveaux = [
  { id: "niveau-1", label: "Niveau 1", description: "Première année - Préparez vos concours avec les ressources du Niveau 1." },
  { id: "niveau-2", label: "Niveau 2", description: "Deuxième année - Accédez aux sujets de concours de votre filière." },
] as const
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      <div className="mb-8 sm:mb-12 text-center">
        ...
        <p className="text-muted-foreground text-sm sm:text-lg max-w-2xl mx-auto">
          Sélectionnez votre niveau pour accéder aux épreuves de concours par filière.
        </p>
      </div>
